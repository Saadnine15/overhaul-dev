                    ...
                    <div class="Polaris-Card">
                        <div class="Polaris-Card__Section">
                            <div class="Polaris-SettingAction">
                                ...
                                <div class="Polaris-SettingAction__Action">
                                    <button ng-disabled="!headerOption.mapped_to" data-ng-click="updateProducts()" ng-class="Polaris-Button @{{ 'Polaris-Button--primary': headerOption.mapped_to =='test'  }}"><span class="Polaris-Button__Content"><span>Update</span></span></button>
                                </div>
                            </div>
